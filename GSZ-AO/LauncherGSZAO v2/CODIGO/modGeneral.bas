...
' Variables de uso privado de la aplicación
...
On Error GoTo Fallo
    ' Extrae la información obtenida desde internet
    ...
    If Len(FileInfo.FileMD5) > 32 Then ' El MD5 siempre tiene 32 caracteres, no más!
    ...
    If Len(FileInfo.FileMD5) <> 32 Then
        MsgBox "Error con la obtención del MD5 " & FileInfo.FileMD5 & vbCrLf & Left(FileInfo.FileMD5, 1) & "-" & Right(FileInfo.FileMD5, 1) & vbCrLf & Asc(Left(FileInfo.FileMD5, 1)) & "-" & Asc(Right(FileInfo.FileMD5, 1)) & vbCrLf & "Paquete: " & sData
    End If
Fallo:
End Sub
...
On Error Resume Next
    ...
    If Right$(sTemp, 1) = "_" Then ' ¿Es una actualización?
        ...
        If Not FileExists(LocalPath & sTemp2) Then ' ¿Ya no existe?
            ...
            End
        Else
            Call MsgBox("Ha ocurrido un error en la aplicación de actualización." & vbCrLf & "Elimine manualmente " & Left$(App.EXEName, Len(App.EXEName) - 1) & S_EXE & " y ejecute nuevamente " & App.EXEName & S_EXE, vbOKOnly + vbCritical)
            End
        End If
    ...
    Else
        ...
        If NeedRename = True Then
            Call NextTotal("Verificando la aplicación de actualización...")
        ...
        If NeedDownload = True Then
            Call NextTotal("Descargando una nueva aplicación de actualización...")
    ...
    End If
    Call NextTotal("Aplicación de actualización verificada...")
    DoEvents
...
'CheckFiles: ' Saltear la primer parte de la secuencia (para debuguear unicamente)
    ...
    Else
        ...
        Dim rFiles As String ' Archivos que realmente se descargarán
        rFiles = vbNullString

        ' Hacemos una recorrida preliminal para determinar cuantos archivos hay que descargar realmente y el tamaño total
        ...
        For lI = 0 To UBound(sFiles) - 1
            ...
            If FileExists(LocalPath & FileInfo.FilePath & FileInfo.Filename) Then
                ...
                If MD5File(LocalPath & FileInfo.FilePath & FileInfo.Filename) <> FileInfo.FileMD5 Then
                    ...
                    Call MsgBox("Ha ocurrido un error en la verificación de " & FileInfo.Filename & vbCrLf & "El archivo se encuentra corrupto, por favor verifique que su sistema no tenga virus.", vbCritical + vbOKOnly)
                    End
                End If
            Else
    ...
    ' Se ha terminado de ejecutar la aplicación de actualización
