Attribute VB_Name = "modUsuariosBanco"
'**************************************************************
...
With UserList(UserIndex)
    ...
    If Slot > .CurrentInventorySlots Then
        ...
        Do Until .Invent.Object(Slot).ObjIndex = 0
            ...
            If Slot > .CurrentInventorySlots Then
                Call WriteMensajes(UserIndex, eMensajes.Mensaje085) '"No podés tener mas objetos."
                Exit Sub
            End If
        Loop
...
On Error GoTo ErrHandler
    ...
    If UserList(UserIndex).Invent.Object(Item).Amount > 0 And Cantidad > 0 Then
        ...
        If ObjData(ObjIndex).Log = 1 Then ' 0.13.3
    ...
    With UserList(UserIndex)
        ...
        If Slot > MAX_BANCOINVENTORY_SLOTS Then
            ...
            Do Until .BancoInvent.Object(Slot).ObjIndex = 0
                ...
                If Slot > MAX_BANCOINVENTORY_SLOTS Then
                    Call WriteMensajes(UserIndex, eMensajes.Mensaje086) '"No tienes mas espacio en el banco!!"
                    Exit Sub
                End If
            Loop
        ...
        If Slot <= MAX_BANCOINVENTORY_SLOTS Then 'Slot valido
            ...
            Else
                Call WriteMensajes(UserIndex, eMensajes.Mensaje087) '"El banco no puede cargar tantos objetos."
            End If
        End If
    End With
End Sub
