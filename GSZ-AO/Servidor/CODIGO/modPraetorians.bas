Attribute VB_Name = "modPraetoriansCoopNPC"
'**************************************************************
...
''Se extrae el dato del Servidor.ini en sub LoadSIni
Public iniMapaPretoriano As Integer
''''''''''''''''''''''''''''''''''''''''''''''
...
'    NpcIndex = CrearNPC(PRKING_NPC, iniMapaPretoriano, wp2)
'
...
'    wp.X = wp.X + 3
'    Call ClosestLegalPos(wp, wp2, False, True)
'    NpcIndex = CrearNPC(PRCLER_NPC, iniMapaPretoriano, wp2)
'
'    PretoIndex = PretoIndex + 1
'    Pretorianos(PretoIndex) = NpcIndex
'
...
'    wp.Y = wp.Y + 3
'    Call ClosestLegalPos(wp, wp2, False, True)
'    NpcIndex = CrearNPC(PRGUER_NPC, iniMapaPretoriano, wp2)
'
'    PretoIndex = PretoIndex + 1
'    Pretorianos(PretoIndex) = NpcIndex
'
...
'    wp.X = wp.X - 1
'    Call ClosestLegalPos(wp, wp2, False, True)
'    NpcIndex = CrearNPC(PRCAZA_NPC, iniMapaPretoriano, wp2)
'
'    PretoIndex = PretoIndex + 1
'    Pretorianos(PretoIndex) = NpcIndex
'ErrHandler:
...
'
'        If Not NPCPosM = iniMapaPretoriano Then Exit Sub
'
...
'    Npclist(Paralizado).Contadores.Paralisis = Intervalos(eIntervalos.iParalizado) * 2
'
'Exit Sub
'
'errorh:
