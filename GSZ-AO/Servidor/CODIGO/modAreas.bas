            ...
            For Y = MinY To MaxY
                ...
                If MapData(Map, X, Y).UserIndex Then
                    ...
                    If UserIndex <> TempInt Then
                        ...
                        If Not (UserList(TempInt).flags.AdminInvisible = 1) Then
                            If MakeUserChar(False, UserIndex, TempInt, Map, X, Y) Then ' 0.13.5
                        ...
                        If Not (.flags.AdminInvisible = 1) Then
                            If MakeUserChar(False, TempInt, UserIndex, .Pos.Map, .Pos.X, .Pos.Y) Then ' 0.13.5
                                ' Si esta navegando, siempre esta visible
                ...
                If MapData(Map, X, Y).ObjInfo.ObjIndex Then
                    ...
                    If Not EsObjetoFijo(ObjData(TempInt).OBJType) Then
                        ...
                        ElseIf ObjData(TempInt).OBJType = eOBJType.otDestruible Then ' GSZAO
...
ErrHandler:
    ...
    LogError ("AgregarUser::Error " & Err.Number & " - Desc: " & Err.description & _
