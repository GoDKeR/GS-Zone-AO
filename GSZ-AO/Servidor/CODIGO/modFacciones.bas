...
With UserList(UserIndex)
    ...
    If Expulsado Then
        Call WriteMensajes(UserIndex, eMensajes.Mensaje090) '"¡¡¡Has sido expulsado del ejército real!!!"
    Else
        Call WriteMensajes(UserIndex, eMensajes.Mensaje091) '"¡¡¡Te has retirado del ejército real!!!"
    End If
...
With UserList(UserIndex)
    ...
    'Call PerderItemsFaccionarios(UserIndex)
    If Expulsado Then
        Call WriteMensajes(UserIndex, eMensajes.Mensaje092) '"¡¡¡Has sido expulsado de la Legión Oscura!!!"
    Else
        Call WriteMensajes(UserIndex, eMensajes.Mensaje093) '"¡¡¡Te has retirado de la Legión Oscura!!!"
    End If
