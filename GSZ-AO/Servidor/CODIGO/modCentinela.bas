        ...
        With Centinela(index)
            ...
            If .Activo Then
                ...
                If UserIndex <> 0 Then
                    ...
                    If getInterval(TActual, .SpawnTime) >= 5000 Then ' 0.13.5
        ...
        With Centinela(index)
            ...
            If .Activo Then
                ...
                Else
                    ...
                    If modMatematicas.Distancia(Npclist(.NpcIndex).Pos, UserList(UserIndex).Pos) > 5 Then
...
'Author: ZaMa
'Last modified: 27/07/2012 - ^[GS]^
'Renueva el timer que resetea el flag "CentinelaOk" de todos los modUsuarios.
'*************************************************
