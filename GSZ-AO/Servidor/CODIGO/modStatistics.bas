...
Public Sub Initialize()
    ReDim trainningInfo(1 To iniMaxUsuarios) As trainningData
End Sub
...
'***************************************************
    ...
    With trainningInfo(UserIndex)
        ...
        .trainningTime = .trainningTime + (getInterval((GetTickCount() And &H7FFFFFFF), .startTick) / 1000) ' 0.13.5
...
'***************************************************
    ...
    With trainningInfo(UserIndex)
        ...
        Print #handle, UCase$(UserList(UserIndex).Name) & " completó el nivel " & CStr(UserList(UserIndex).Stats.ELV) & " en " & CStr(.trainningTime + (getInterval((GetTickCount() And &H7FFFFFFF), .startTick) / 1000)) & " segundos." ' 0.13.5
