...
Begin VB.Form frmSkills 
   ...
   Begin GSZAOCliente.uAOButton cCerrar 
      ...
      FCOL            =   7314354
      OCOL            =   16777215
      PICE            =   "frmSkills3.frx":37466
      PICF            =   "frmSkills3.frx":37482
      PICH            =   "frmSkills3.frx":3749E
      PICV            =   "frmSkills3.frx":374BA
   ...
   Begin GSZAOCliente.uAOButton cConfirmar 
      ...
      FCOL            =   7314354
      OCOL            =   16777215
      PICE            =   "frmSkills3.frx":374D6
      PICF            =   "frmSkills3.frx":374F2
      PICH            =   "frmSkills3.frx":3750E
      PICV            =   "frmSkills3.frx":3752A
      BeginProperty FONT {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Arial"
         Size            =   12
         Charset         =   0
...
On Error GoTo Fallo
    ...
    Exit Sub
Fallo:
    Call MsgBox("Error al intentar confirmar los cambios de habilidates.", vbCritical + vbOKOnly)
End Sub
