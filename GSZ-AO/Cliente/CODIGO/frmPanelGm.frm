...
Private Sub cmdNOCAOS_Click()
    ...
    If LenB(Nick) <> 0 Then
        tStr = InputBox("Escriba el motivo de la expulsión.", "Expulsión de la Legión Oscura a " & Nick) ' 0.13.5
        If LenB(tStr) <> 0 Then _
...
Private Sub cmdNOREAL_Click()
    ...
    If LenB(Nick) <> 0 Then
        tStr = InputBox("Escriba el motivo de la expulsión.", "Expulsión del Ejército Real a " & Nick) ' 0.13.5
        If LenB(tStr) <> 0 Then _
