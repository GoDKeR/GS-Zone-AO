...
' 1 = Utiliza una fuente "fija", configurada en modGeneral, la función "CargarServidores()".
' 2 = Utiliza una fuente obtenida de internet, configurada en modGeneral, la función "CargarServidores()".
...
' * Configuración de estilos de controles
...
' * Configuración de estilo de controles
