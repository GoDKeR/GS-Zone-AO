...
Public Sub Main()
    ...
    frmLauncher.Label1.Caption = "Esperando al Updater."
...
'On Error Resume Next
    ...
    Call InitTotal(3)
    frmLauncher.tSF.Caption = vbNullString
    
    frmLauncher.Show
    frmLauncher.WindowState = 0
    frmLauncher.Left = (Screen.Width - frmLauncher.Width) / 2
    frmLauncher.Top = (Screen.Height - frmLauncher.Height) / 2
    ...
    sTemp = frmLauncher.Inet.OpenURL(UPDATER_CHECK_URL & "&" & strAntiProxy)
    DoEvents
...
CheckFiles:
    ...
    DoEvents
    sTemp = frmLauncher.Inet.OpenURL(LIST_CHECK_URL & "?" & strAntiProxy)
    DoEvents
    If (InStr(1, sTemp, "|") = 0) Then
        Call MsgBox("Ha ocurrido un error en la comprobación de actualización." & vbCrLf & "Descargue nuevamente el archivo de actualización de la web " & OFICIAL_URL, vbCritical + vbOKOnly)
        End
            ...
            If FileExists(LocalPath & FileInfo.FilePath & FileInfo.Filename) Then
                ...
                If NeedDownload = True Then
                    ...
                    If LCase$(Right(FileInfo.Filename, 3)) = ".ao" Then ' Es un .AO?
                        ...
                        ActualAOVersion = Compression.GetVersion(LocalPath & FileInfo.FilePath & FileInfo.Filename)
    ...
    frmLauncher.Inet.Cancel
    frmLauncher.Show
    
    frmLauncher.Label1.Caption = "Lanzando Cliente"
    Call Shell(App.Path & "/Cliente.exe" & " " & "1")
    ...
    With frmLauncher.Inet
        ...
        ElseIf .Tag = icResponseCompleted Then ' Operación completada
            ...
            If lngFileLength > 0 Then
                ...
                frmLauncher.tSF.Caption = "Descargando " & ReturnFileOrFolder(strURL, True, True) & "..."
                frmLauncher.sSF.Value = 0
                frmLauncher.sSF.Max = lngFileLength
                ' Lo hacemos visible...
                frmLauncher.tSF.Visible = True
                frmLauncher.sSF.Visible = True
                ...
                Do
                    ...
                    frmLauncher.sSF.Value = lngBytesReceived ' Actualizamos el progreso de descarga...
                    DoEvents
                Loop While UBound(b, 1) > 0
                ' Cerramos el archivo
                Close #intFile
                ' Ocultamos los controles
                frmLauncher.tSF.Visible = False
                frmLauncher.sSF.Visible = False
...
If frmLauncher.Winsock1.State = sckConnected Then
    frmLauncher.lblSt.Caption = "ONLINE"
    frmLauncher.lblSt.ForeColor = vbGreen
    frmLauncher.Timer1.Enabled = False
Else
    
    frmLauncher.lblSt.ForeColor = vbRed
    frmLauncher.lblSt.Caption = "OFFLINE"
End If
